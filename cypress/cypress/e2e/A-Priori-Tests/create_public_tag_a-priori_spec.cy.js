describe("Public Tag Creation", () => {
  ...
  it("allows a user to create a public Tag with a priori data", () => {
  ...
  it("allows a user to create a public Tag with a priori data and add a description with less than 500 characters (a priori)", () => {
    cy.fixture("a-priori-data-mockaroo").then((data) => {
      cy.get('a[class="ember-view gh-btn gh-btn-primary"]').click();
      cy.get('input[id="tag-name"]').type(data[0].tagName);
  ...
  it("allows a user to create a public Tag with a priori data and edit the slug with a priori data", () => {
    cy.fixture("a-priori-data-mockaroo").then((data) => {
      cy.get('a[class="ember-view gh-btn gh-btn-primary"]').click();
      cy.get('input[id="tag-name"]').type(data[0].tagName);
  ...
  it("wont allow an user to create a public Tag with a priori data and add a description with more than 500 characters (a priori)", () => {
    cy.fixture("a-priori-data-mockaroo").then((data) => {
      cy.get('a[class="ember-view gh-btn gh-btn-primary"]').click();
      cy.get('input[id="tag-name"]').type(data[0].tagName);
