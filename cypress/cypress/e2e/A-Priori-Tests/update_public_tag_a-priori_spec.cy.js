...
describe("Public Tag Editing", () => {
  ...
  it("allows a user to update a Public Tag with a priori data", () => {
  ...
  it("allows a user to update a Public Tag description with a priori data", () => {
    cy.fixture("a-priori-data-mockaroo").then((data) => {
      cy.contains("Public tags").first().click();
      cy.get('a[title="Edit tag"]').first().click();
      cy.get('input[id="tag-name"]').clear();
  ...
  it("will not allows a user to update a Public Tag description with a priori data if its over 500 characters", () => {
    cy.fixture("a-priori-data-mockaroo").then((data) => {
      cy.contains("Public tags").first().click();
      cy.get('a[title="Edit tag"]').first().click();
      cy.get('input[id="tag-name"]').clear();
