...
describe("Internal Tag Creation", () => {
  ...
  it("allows a user to create a internal Tag with random data", () => {
  ...
  it("allows a user to create a internal Tag with random data and add a description with less than 500 characters (random)", () => {
    cy.get('a[class="ember-view gh-btn gh-btn-primary"]').click();
    cy.get('input[id="tag-name"]').type("#" + faker.lorem.words(2));
  ...
  it("allows a user to create a internal Tag with random data and edit the slug with random data", () => {
    cy.get('a[class="ember-view gh-btn gh-btn-primary"]').click();
    cy.get('input[id="tag-name"]').type("#" + faker.lorem.words(2));
  ...
  it("wont allow an user to create a internal Tag with random data and add a description with more than 500 characters (random)", () => {
    cy.get('a[class="ember-view gh-btn gh-btn-primary"]').click();
    cy.get('input[id="tag-name"]').type("#" + faker.lorem.words(2));
